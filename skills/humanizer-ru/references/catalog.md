...
Слой выше слов: ЧТО рассказано и как устроено, а не какими словами. Категории A-M правят стиль, а у детекторов есть и второй этаж, который стилевой правкой не сдвигается. StoryScope (arXiv:2604.03136, COLM 2026: 10 272 промпта, человек и пять LLM, 61 608 историй по ~5000 слов, 304 фичи на текст) измерил это прямо: стилевая перезапись LAMP (клише, канцелярит, «фиолетовая проза»: ровно то, что чинит каталог выше) роняет дискурсную детекцию всего на 1.6 п.п., с 95.5% до 93.9% macro-F1. Из 304 фич стилевых лишь 39; одних дискурсных (257) хватает на 93.2% macro-F1 в задаче человек/ИИ. Вычистил стиль, а подпись осталась: она в устройстве рассказа. Категория дополняет A-M, не заменяет: сначала стилевой слой, потом дискурсный. Граница честности: статья мерила беллетристику ~5000 слов; перенос на посты, кейсы и письма - экстраполяция механизма, статьёй не проверенная. Шесть паттернов ниже: самые сильные и переносимые сигналы статьи, весь дискурс (257 фич) они не покрывают. Паттерны 61 и 64 - предложения автору, не автоправки.

**59. Явная мораль в финале.** ИИ-нарратор проговаривает тему истории прямым текстом в 77% случаев, человек в 52% (самый большой разрыв в статье). Финал с уроком отдельным предложением: «эта история учит нас...», «мораль проста...», «и тогда она поняла, что главное...». Смысл уже виден из событий, а финал его всё равно озвучивает. Вырежи озвучку: закончи действием, деталью или репликой, читатель соберёт вывод сам. Не то же, что #4 (формульные выводы): там клише-фразы, здесь смысловой уровень, мораль палит и без клише. Шаблонные формулы морали ловит сканер (категория «Финальная мораль»); мораль без шаблонных слов оценивай по прочтении.

До: «Мы всё же успели к дедлайну. Эта история учит нас, что планирование и командная работа решают всё.»
После: «Мы всё же успели к дедлайну. Планёрку по средам теперь не пропускает никто.»

**60. Портретное введение героя.** ИИ вводит персонажа внешним описанием в 52% историй, человек в 30%: рост, возраст, причёска и характер анкетой при первом появлении. Человек чаще знакомит через поступок или реплику, а портрет раздаёт по ходу, если он вообще нужен. Работает и вне беллетристики: клиент в кейсе, знакомый в посте. Проверь первое появление каждого героя: характеристику-анкету перепиши в конкретное действие или прямую речь.

До: «Анна была высокой женщиной сорока лет, с усталыми глазами и строгим пучком тёмных волос.»
После: «Анна, не поздоровавшись, выключила проектор: совещание закончилось, не начавшись.»

**61. Эмоция только через тело.** Контринтуитивный маркер: телесной метафорой злоупотребляет ИИ, не человек. ИИ передаёт чувство через физиологию в 81% историй, человек в 38%: «сердце сжалось», «ком в горле», «холодок по спине». Прямое называние чувства, наоборот, человеческий почерк: 29% у людей против 8% у ИИ. Люди спокойно пишут «мне было страшно» и «до сих пор стыдно»; модель прячет эмоцию в тело, потому что так её учили выполнять «show, don't tell». Сигнал: по всему тексту чувства поданы исключительно телом и ни разу не названы. Это предложение автору, не автоправка: что именно чувствовал герой, знает автор. Предложи назвать одну-две эмоции прямо, решение за ним.

**62. Бесшовная причинная цепь.** У ИИ каждое событие вытекает из предыдущего: непрерывность каузальной цепи 4.20 у ИИ против 3.92 у человека по шкале 1-5. Живая история содержит швы: совпадение, случайность, ветку, которая никуда не привела. Проследи цепь событий целиком; если на весь текст ни одного провисания и ни одной случайности, это сигнал. Лечится одним швом: событие без подготовки, деталь, которая не выстрелила. Родня #44, но зеркально: там гладкость фраз-связок, здесь гладкость самих событий. С #34 не конфликтует: там абзацы рассуждения связаны слабо, здесь события истории связаны слишком хорошо. Автосканером не ловится, оценка только по прочтении.

**63. Строго линейная хронология.** Человек прыгает во времени чаще ИИ: хронологическая прерывистость 2.40 против 2.12 по шкале статьи. Флешбек, забегание вперёд («забегая вперёд: клиент вернулся»), возврат к предыстории в середине. ИИ рассказывает строго по календарю. Для длинных текстов (>500 слов) подача строго по порядку, без единого сдвига - сигнал. Предложи один сдвиг таймлайна там, где он усиливает: начать с развязки, вспомнить предысторию в середине. Короткий текст не трогай: на 300 словах линейность нормальна.

**64. Нет обращения к читателю.** Человек говорит с читателем напрямую вчетверо чаще ИИ: 28% против 7%. Вопрос в лоб, «представьте», «вы наверняка такое видели». Сигнал здесь - отсутствие, поэтому сканер его не считает: смотри глазами. Применяй только там, где формат обращение допускает: пост, рассылка, колонка, лендинг. В новость, документацию и научный текст не тащи. Это предложение автору, не автоправка: обращение меняет интонацию всего текста, вставлять его молча нельзя. Предложи одно-два места, решает автор.
...
**Финальная мораль:** «мораль этой истории», «мораль проста», «мораль такова», «эта история учит нас», «эта история о том, что»: нарратор проговаривает вывод за читателя (паттерн #59). Сканер ловит только шаблонные формулы; мораль, изложенную без них, оценивай по прочтении
