...
- **Зелёный** (чисто): НЕ ТРОГАТЬ. Переписывание чистого абзаца вносит новые AI-маркеры.

**Шаг 2. Калибровка голоса.**

Если пользователь дал образцы своего письма — структурированный анализ:
...
| Тире в >30% предложений | Монотонный AI-ритм | Замени часть на запятые, двоеточия, точки |
...
- [ ] Тире в не более 30% предложений
