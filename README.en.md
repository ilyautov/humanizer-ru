...
The scanner also ships without the skill, as the [`ru-humanizer`](https://pypi.org/project/ru-humanizer/) package on PyPI (the `humanizer-ru` name there belongs to a namesake). Same `scan.py`, as a command:
