...
|---|---|---|---|
| Маркетинг / соцсети | Максимальная | Все 42 паттерна + HARD BANS + тональность | — |
...
| B | Высокие | Размытые авторитеты (2), кальки (7), «является» (8), водянистость (26), «данный» (30), эмоциональная стерильность (31) | Во всех режимах кроме юридических |
...
| D | Стилистические | Болд (16), кавычки (21), списки (19), пунктуация (20), грамотность (36), типографика (37) | По контексту, не обязательно |

При ограниченном времени или токенах: исправляй сверху вниз (A → B → C → D).

---

## Процесс (5 шагов + dual-pass аудит)

**Шаг 1. Диагностика.** Прочитай текст. Найди конкретные экземпляры паттернов из каталога ниже. Не все 42, только те, что реально есть. Пометь каждый найденный экземпляр.
...
**Шаг 3. Полное переписывание.** Перепиши текст целиком, сохраняя смысл. Не правь по слову. Одновременно убирай паттерны AI, добавляй голос и варьируй структуру. Сверяйся с паспортом голоса.

**Шаг 4. Dual-pass аудит.**
...
## Каталог: 42 паттерна AI-генерации в русском
