...
- [ ] Конкретика (имена, цифры, примеры вместо «многие», «часто», «эксперты») — только из исходника
