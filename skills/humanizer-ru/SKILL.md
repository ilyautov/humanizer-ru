---
name: humanizer-ru
description: "Качество русского текста для агента. Use when пользователь просит очеловечить, вычитать, отредактировать, поправить, причесать или проверить русскоязычный текст: убрать канцелярит, воду и нейросетевую манеру, вернуть живой ритм и голос автора. Три режима: полное редактирование, аудит (диагностика без переписывания) и точечная правка одной категории. Со скиллом едет детерминированный сканер scripts/scan.py: считает хард-баны, категории маркеров, ритм предложений и морфологию, печатает ЧИСТОТА: N/100, поэтому правка измерима («было N, стало M»). Знает регистр: флаг --genre academic/legal/fiction/news снимает маркеры, законные для научного, юридического и новостного текста. Калибруется по образцам письма пользователя. Работает ТОЛЬКО с русским текстом: для английского используй humanizer, для итальянского humanizer-it. НЕ используй для: перевод, написание с нуля, грамматика без стилистической правки, код."
license: MIT
---
