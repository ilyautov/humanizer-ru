...
[![Версия](https://img.shields.io/badge/версия-3.15.1-blueviolet)](https://github.com/ilyautov/humanizer-ru/blob/main/CHANGELOG.md)
...
**Три режима работы:**
- Полное редактирование (по умолчанию): все 54 паттерна
...
**Как убрать признаки ChatGPT из текста?** Главные сигналы: «не просто X, а Y» (80%+ AI-текстов), «стоит отметить», «является», длинное тире, отсутствие частиц «же/ведь/вот», равномерная информационная плотность. Скилл ловит и заменяет все 54 паттерна.
