...
|---|---|---|---|
| Маркетинг / соцсети | Максимальная | Все 53 паттерна + HARD BANS + тональность | - |
...
**Шаг 1. Диагностика + сегментная разметка.** Прочитай текст. Найди конкретные экземпляры паттернов из каталога ниже. Не все 53, только те, что реально есть. Пометь каждый найденный экземпляр. Затем размечай абзацы светофором:
...
## Каталог: 53 паттерна AI-генерации в русском
...
### L. Стилистические фингерпринты 2025-2026 (49-53)
