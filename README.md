...
<p align="center">
  <a href="https://humanizer-ru.aifrontier.tech/">
    <img src="assets/social-preview.png" alt="humanizer-ru: убирает следы нейросети из русского текста. 65 признаков, 21 запрет, сканер в комплекте" width="720">
  </a>
</p>
...
**65 паттернов AI-генерации в 15 категориях:**
...
**Как убрать признаки ChatGPT из текста?** Главные сигналы: «не просто X, а Y» (80%+ AI-текстов), «стоит отметить», «является», длинное тире, отсутствие частиц «же/ведь/вот», равномерная информационная плотность. Скилл ловит и заменяет все 65 паттернов.
