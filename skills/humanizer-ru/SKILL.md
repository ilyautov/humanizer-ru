...
|---|---|---|---|
| Маркетинг / соцсети | Максимальная | Все 58 паттернов + HARD BANS + тональность | - |
...
Проход 1, «Детектор»: перечитай черновик, ищи остатки каждой из 13 категорий паттернов (A-M). Достаточно 30 секунд на категорию.
...
Полный каталог 58 паттернов AI-генерации (13 категорий A-M, с примерами «до/после»
